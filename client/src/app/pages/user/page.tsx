        ...
        <Layout>
            ...
            <div className="flex flex-col items-center justify-center">
                <div className='space-y-6 max-sm:w-full sm:max-w-sm w-3/4'>
                        ...
                        <Collapse title="Change Password">
                            <div className='flex flex-col'>
                                ...
                                <div className='relative'>
                                    <input ref={currentPasswordElement} onBlur={()=>{
                            ...
                            <div className='flex flex-col'>
                                ...
                                <div className='relative'>
                                    <input ref={newPasswordElement} onBlur={()=>{
                                        ...
                                        } value={newPassword} onChange={(e)=>setNewPassword(e.target.value)} placeholder='******' className='px-2 outline-0 outline-orange-400 dark:bg-neutral-600 dark:text-white w-full rounded-md h-10 ring-1 ring-orange-400 border-0 focus:ring-2' type={newPasswordVisible ? 'text' : 'password'} name='new-password'/>
                                    { newPasswordVisible ? 
                        ...
                        <button onClick={async(e)=>await signOut({callbackUrl:'/',redirect:true})} className="text-white w-full p-2 mt-4 bg-orange-500 md:hover:bg-orange-400 max-md:active:bg-orange-400">
