    ...
    return (
        <Layout>
            ...
            { isModalVisible ?
             ...
             : null}
            { isModalFailVisible ?
             <Modal body="Failed to delete category. Please check connection and try again" title="Failed to Delete" callback={
                ...
                {loading ? <Loading screen={false} />:
                    ...
                    <table className="w-full ring-1 ring-slate-500 dark:ring-0"> 
                        <thead className="bg-slate-100 dark:bg-slate-600">
                            <tr>
                                <td className="text-black d p-1 dark:text-white font-bold text-sm">Category</td>
